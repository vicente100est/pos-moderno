...
$the_store = $statement->fetch(PDO::FETCH_ASSOC);
$preference = unserialize($the_store['preference']);

// set ftp info
$ftp_hostname = isset($preference['ftp_hostname']) ? $preference['ftp_hostname'] : '';
$ftp_username = isset($preference['ftp_username']) ? $preference['ftp_username'] : '';
$ftp_password = isset($preference['ftp_password']) ? $preference['ftp_password'] : '';
