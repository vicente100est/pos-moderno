...
class ModelQuotation extends Model 
{
    public function createQuotation($request, $store_id = null)
    {
        ...
        $statement->execute(array($reference_no, $store_id, $customer_id, $customer_mobile, $quotation_note, $total_items, $status, $payment_status, $is_installment_order, $user_id, $created_at));
        ...
        $statement->execute(array($reference_no, $store_id, $subtotal, $discount_type, $discount_amount, $installment_interest_amount, $installment_interest_percentage, $item_tax, $order_tax, $tcgst, $tsgst, $tigst, $total_purchase_price, $shipping_type, $shipping_amount, $others_charge, $payable_amount
        ));
