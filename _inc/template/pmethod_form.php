...
<form class="form-horizontal" id="pmethod-form" action="pmethod.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="pmethod_name" ng-init="pmethodName='<?php echo $pmethod['name']; ?>'" value="<?php echo $pmethod['name']; ?>" name="pmethod_name" ng-model="pmethodName" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="code_name" name="code_name"  value="<?php echo $pmethod['code_name'] ? $pmethod['code_name'] : "{{ pmethodName | strReplace:' ':'_' | lowercase }}"; ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <select id="status" class="form-control" name="status" >
          <option <?php echo isset($pmethod['status']) && $pmethod['status'] == '1' ? 'selected' : null; ?> value="1"><?php echo trans('text_active'); ?></option>
          <option <?php echo isset($pmethod['status']) && $pmethod['status'] == '0' ? 'selected' : null; ?> value="0"><?php echo trans('text_in_active'); ?></option>
        </select>
      </div>
    </div>
