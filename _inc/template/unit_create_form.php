<form id="create-unit-form" class="form-horizontal" action="unit.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="text" class="form-control" id="unit_name" value="<?php echo isset($request->post['unit_name']) ? $request->post['unit_name'] : null; ?>" name="unit_name" ng-model="unitName" required>
      </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
          <input type="text" class="form-control" id="code_name" value="{{ unitName | strReplace:' ':'_' | lowercase }}" name="code_name" required>
        </div>
    </div>
