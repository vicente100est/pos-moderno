...
<div class="content-wrapper" ng-controller="ReportPurchaseTaxController">

  <!-- Content Header Start -->
  <section class="content-header">
    <?php include ("../_inc/template/partials/apply_filter.php"); ?>
    <h1>
      <?php echo trans('text_purchase_tax_report_title'); ?>
      <small>
        <?php echo store('name'); ?>
      </small>
    </h1>
        ...
        <div class="row">
          <!-- <div class="<?php echo get_preference('invoice_view') == 'indian_gst' ? 'col-sm-6' : 'col-sm-12';?>">
            <div class="row">
              <div class="col-sm-6">
                ...
                <h4><?php echo currency_format(purchase_price(from(), to()));?></h4>
                <p><?php echo trans('text_purchase_amount'); ?></p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="small-box bpurple">
                  <h4><?php echo currency_format(get_purchase_tax('item_tax', from(), to()));?></h4>
                  <p><?php echo trans('text_total_tax_amount'); ?></p>
                </div>
              </div>
            </div>
          </div> -->
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="small-box bblue">
                  <h4><?php echo currency_format(get_purchase_tax('order_tax', from(), to()));?></h4>
          ...
          <div class="col-sm-6">
            <div class="small-box col-sm-4 borange">
              <h4><?php echo currency_format(get_purchase_tax('igst', from(), to()));?></h4>
              <p><?php echo trans('text_igst'); ?></p>
            </div>
            <div class="small-box col-sm-4 bolive">
              <h4><?php echo currency_format(get_purchase_tax('cgst', from(), to()));?></h4>
              <p><?php echo trans('text_cgst'); ?></p>
            </div>
            <div class="small-box col-sm-4 borange">
              <h4><?php echo currency_format(get_purchase_tax('sgst', from(), to()));?></h4>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo trans('text_purchase_tax_report_sub_title'); ?>
            </h3>
          </div>
          <div class="box-body">
