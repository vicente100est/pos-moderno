window.angularApp.controller("ReportPurchaseBrandWiseController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Purchase Report (Brand wise)-"+from+" to "+to,
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Purchase Report (Brand wise)", title:"Purchase Report (Brand wise)", html: thehtml});
    });
