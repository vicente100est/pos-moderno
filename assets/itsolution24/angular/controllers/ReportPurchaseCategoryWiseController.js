window.angularApp.controller("ReportPurchaseCategoryWiseController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    dt.dataTable({
        ...
        "dom": 'lfBrtip',
        "serverSide": true,
        "ajax": API_URL + "/_inc/report_purchase_categorywise.php?from="+$from+"&to="+$to,
        "fixedHeader": true,
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Purchase Report (Category wise)-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Purchase Report (Category wise)-"+from+" to "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
            {
                ...
                titleAttr: "Excel",
                title: window.store.name + " > Purchase Report (category wise)",
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Purchae Report (Category Wise)", title:"Purchae Report (Category Wise)", html: thehtml});
    });
