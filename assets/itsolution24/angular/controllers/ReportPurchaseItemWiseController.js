window.angularApp.controller("ReportPurchaseItemWiseController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    dt.dataTable({
        ...
        "dom": 'lfBrtip',
        "serverSide": true,
        "ajax": API_URL + "/_inc/report_purchase_itemwise.php?from="+$from+"&to="+$to,
        "fixedHeader": true,
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Purchase Report (Item wise)-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Purchase Report (Item wise)-"+from+" to "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
            ...
            },
            {
                ...
                titleAttr: "CSV",
                title: window.store.name + " > Purchase Report (item wise)",
                exportOptions: {
                    columns: [printColumns]
                }
            },
