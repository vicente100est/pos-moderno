window.angularApp.controller("ReportPurchaseSupplierWiseController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    dt.dataTable({
        ...
        "dom": 'lfBrtip',
        "serverSide": true,
        "ajax": API_URL + "/_inc/report_purchase_supplierwise.php?from="+$from+"&to="+$to,
        "fixedHeader": true,
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Purchase Report (Supplier wise)-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Purchase Report (Supplier wise)-"+from+" to "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
	...
	*/
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Purchase Report (Supplier Wise)", title:"Purchase Report (Supplier Wise)", html: thehtml});
    });
