window.angularApp.controller("ReportPurchaseTaxController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    dt.dataTable({
        ...
        "dom": "lfBrtip",
        "serverSide": true,
        "ajax": API_URL + "/_inc/report_purchase_tax.php?from="+$from+"&to="+$to,
        "fixedHeader": true,
        "order": [[ 0, "desc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Purchase Tax Report-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Purchase Tax Report-"+from+" to "+to,
                exportOptions: {
                    columns: [printColumns]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        e.preventDefault();
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Purchase Tax Report", title:"Purchase Tax Report", html: thehtml});
    });
}]);