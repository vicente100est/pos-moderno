...
function (
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Supplier Due Paid Report-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Supplier Due Piad Report-"+from+" to "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "report", subject: "Supplier's Duepaid Report", title:"Supplier's Duepaid Report", html: thehtml});
    });
