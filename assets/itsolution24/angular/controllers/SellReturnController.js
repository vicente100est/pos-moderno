window.angularApp.controller("SellReturnController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
...
function (
    ...
    $("#invoice-invoice-list").dataTable({
        ...
        "dom": "lfBrtip",
        "serverSide": true,
        "ajax": API_URL + "/_inc/sell_return.php?from="+$from+"&to="+$to,
        "fixedHeader": true,
        "order": [[ 0, "desc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "buttons": [
            {
                ...
                titleAttr: "Print",
                title: "Sell Return Listing-"+from+" to "+to,
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Sell Return Listing-"+from+" to "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Sell Return Listing", title:"Sell Return Listing", html: thehtml});
    });
}]);