...
function (
        ...
        "aoColumns": [
            {data : "p_id"},
            {
                ...
                "mRender": function (data, type, row) {
                    return "<a href=\"product_details.php?p_id=" + row['p_id'] + "&p_name=" + row['p_name'] + "\">" + row['p_name'] + "</a";
                }
            },
            {data : "supplier"},
	...
	*/
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Stock Alert Listing", title:"Stock Alert Listing", html: thehtml});
    });
}]);