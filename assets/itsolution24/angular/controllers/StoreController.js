...
function (
    ...
    $("#update-store-btn").on("click", function(e) {
        ...
        $http({
            url: window.baseUrl + "/admin/" + actionUrl,
            method: "POST",
            data: form.serialize(),
            cache: false,
            processData: false,
    ...
    $("#email-btn").on( "click", function (e) {
        e.stopPropagation();
        e.preventDefault();
        dt.find("thead th:nth-child(6), thead th:nth-child(7), thead th:nth-child(8), tbody td:nth-child(6), tbody td:nth-child(7), tbody td:nth-child(8), tfoot th:nth-child(6), tfoot th:nth-child(7), tfoot th:nth-child(8)").addClass("hide-in-mail");
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "sTore Listing", title:"sTore Listing", html: thehtml});
    });
