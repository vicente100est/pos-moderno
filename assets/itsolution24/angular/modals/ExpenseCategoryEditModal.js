window.angularApp.factory("ExpenseCategoryEditModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function (API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function(expense_category) {
        ...
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                            "<button ng-click=\"closeExpenseCategoryEditModal();\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>" +
            ...
            controller: function ($scope, $uibModalInstance) {
                $http({
                  url: window.baseUrl + "/_inc/expense_category.php?category_id=" + expense_category.category_id + "&action_type=EDIT",
                  method: "GET"
                })
                ...
                $(document).delegate("#expense-category-update", "click", function(e) {
                    ...
                    then(function(response) {
                        ...
                        .then(function (willDelete) {
                            if (willDelete) {
                                $scope.closeExpenseCategoryEditModal();
