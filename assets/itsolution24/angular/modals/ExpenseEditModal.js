window.angularApp.factory("ExpenseEditModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function (API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function(expense) {
        ...
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                            "<button ng-click=\"closeExpenseEditModal();\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>" +
            ...
            controller: function ($scope, $uibModalInstance) {
                $http({
                  url: API_URL + "/_inc/expense.php?id=" + expense.id + "&action_type=EDIT",
                  method: "GET"
                })
                ...
                $(document).delegate("#edit-expense-update", "click", function(e) {
                ...
                $scope.closeExpenseEditModal = function () {
